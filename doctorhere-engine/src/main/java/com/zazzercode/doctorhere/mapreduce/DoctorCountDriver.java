 ...
 *
 */
public class DoctorCountDriver extends Configured implements Tool{

	@Override
	public int run(String[] arg0) throws Exception {
		JobConf jobConf = new JobConf(getConf(), DoctorCountDriver.class);
		jobConf.setJarByClass(getClass());
		jobConf.setJobName("DoctorCountDriver");
